...
export const myOrdersReducer = (state = { myOrderList: [] }, action) => {
  switch (action.type) {
    case ORDER_MY_LIST_REQUEST:
      return { loading: true };
    case ORDER_MY_LIST_SUCCESS:
      return { loading: false, myOrderList: action.payload };
...
export const orderDeliverReducer = (state = { orderDeliver: {} }, action) => {
  switch (action.type) {
    case ORDER_DELIVER_REQUEST:
      return { loading: true };
    case ORDER_DELIVER_SUCCESS:
      return { loading: false, success: true, orderDeliver: action.payload };
