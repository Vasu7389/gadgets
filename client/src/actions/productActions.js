...
export const deleteProductByIdAction = (id) => async (dispatch, getState) => {
  try {
    dispatch({
...
export const productCreateResetDispatch = () => (dispatch) => {
...
export const productUpdateResetDispatch = () => async (dispatch) => {
